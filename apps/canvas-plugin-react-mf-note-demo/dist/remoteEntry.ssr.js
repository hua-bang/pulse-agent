  ...
  async function getExposesMap() {
    exposesMapPromise ??= import("virtual:mf-exposes-ssr:__mfe_internal__pulse_canvas_demo_note__remoteEntry_js").then((mod) => mod.default ?? mod);
  ...
  async function init(shared = {}, initScope = []) {
    ...
    const initToken = { from: "pulse_canvas_demo_note" };
