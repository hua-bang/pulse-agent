...
export interface PluginNodeCapabilities {
    ...
    write?(ref: PluginNodeRef, input: PluginNodeWriteInput): PluginNodeWritePatch | Promise<PluginNodeWritePatch>;
    actions?: Record<string, (ref: PluginNodeRef, input?: unknown) => PluginNodeActionResult | Promise<PluginNodeActionResult>>;
}
