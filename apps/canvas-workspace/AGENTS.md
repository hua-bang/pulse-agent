...
| Renderer routes and full-app surfaces | `harness/knowledge/renderer-surfaces.md`, `src/renderer/src/App.tsx`, `src/renderer/src/app/shell/Workbench/`, `src/renderer/src/components/dock/RightDock/` |
