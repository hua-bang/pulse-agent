...
- MCP Apps support inline and right-Dock fullscreen modes. PiP, app model-context updates, and state persistence into later model turns are not yet supported.
