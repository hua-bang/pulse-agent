...
`src/renderer/src/components/views/WorkspaceNodes/NodeDetailPanel.tsx`, rendered by
TWO hosts:

- the `/nodes/<ws>/<id>` page route
  (`src/renderer/src/components/views/WorkspaceNodes/NodeDetailPage.tsx`);
- the dock tab
...
- `src/renderer/src/components/views/WorkspaceNodes/NodeCanvasPreview.tsx` adapts
...
`src/renderer/src/components/views/WorkspaceNodes/nodeDetailDescriptor.ts` is the
...
- **Web (`iframe`) and Mindmap** are rich working surfaces
  ...
  - The Info inspector itself lives in
    `src/renderer/src/components/views/WorkspaceNodes/NodeDetailHeader.tsx`
...
- **Mindmap** retains selected-topic editing, pointer-event background pan,
  ...
  `src/renderer/src/components/views/WorkspaceNodes/useMindmapDetailPan.ts`.
...
(`src/renderer/src/components/views/WorkspaceNodes/NodeCanvasPreview.tsx`):
...
- the panel shows a retry/discard banner
  (`src/renderer/src/components/views/WorkspaceNodes/NodeCanvasSaveError.tsx`);
...
Bound test:
`src/renderer/src/components/views/WorkspaceNodes/__tests__/NodeCanvasPreview.test.tsx`
...
`src/renderer/src/components/views/WorkspaceNodes/useWorkspaceNodes.ts`'s
...
- `src/renderer/src/components/views/WorkspaceNodes/useNodeDetailBridges.ts`
...
`src/renderer/src/components/views/WorkspaceNodes/NodeDetailPage.tsx` adds a
...
`src/renderer/src/components/views/WorkspaceNodes/NodeTagEditor.tsx`. Capture-phase
...
- `src/renderer/src/components/views/WorkspaceNodes/__tests__/NodeDetailPanel.test.tsx`
- `src/renderer/src/components/views/WorkspaceNodes/__tests__/NodeCanvasPreview.test.tsx`
  — save-failure + rich-presentation guards
- `src/renderer/src/components/views/WorkspaceNodes/__tests__/nodeDetailStyles.test.ts`
- `src/renderer/src/components/dock/RightDock/__tests__/dock-store.test.ts`
- `src/renderer/src/components/views/WorkspaceNodes/__tests__/NodeDetailPage.escape.test.tsx`
- `src/renderer/src/components/views/WorkspaceNodes/useWorkspaceNodes.test.tsx`
