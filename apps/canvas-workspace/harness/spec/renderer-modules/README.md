...
| Workspace node filters | `NodeFilters/index.tsx` ~295 lines; owner CSS 219 lines | search, active scopes, workspace/type/tag popovers and counts follow the owner-folder convention; remaining `NodeCards.css` is 71 lines of cross-filter/card interaction media rules |
