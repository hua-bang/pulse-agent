...
| Workspace node cards | shared card shell CSS ~266 lines; NodeCardPreview CSS 218 lines | file/text/web/image/mindmap/AI preview presentation lives beside `NodeCardPreview/index.tsx`; interactive CardShell/KnowledgeNodeCard styles remain together with their shared interaction media rules |
