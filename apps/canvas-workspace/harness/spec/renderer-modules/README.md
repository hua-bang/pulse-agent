...
| Workspace node detail | NodeDetailDocument CSS ~438 lines; Header 120 lines; Inspector 49 lines; RelationEditor 175 lines; ContextRail 85 lines; Supplementary 75 lines | document header, portaled inspector, relationship editing, source/AI/context rail, and dock disclosures follow owner folders; the bidirectional markup/style contract reads every owner stylesheet; canvas preview remains to migrate |
