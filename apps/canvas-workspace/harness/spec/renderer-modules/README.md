...
| Workspace node detail | NodeDetailDocument CSS ~488 lines; Header 120 lines; RelationEditor 175 lines; ContextRail 85 lines; Supplementary 75 lines | document title/actions/meta/tags, relationship editing, source/AI/context rail, and dock disclosures follow owner folders; the bidirectional markup/style contract reads every owner stylesheet; inspector and canvas preview remain to migrate |
