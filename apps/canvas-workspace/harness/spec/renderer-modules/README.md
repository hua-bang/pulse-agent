...
| Workspace node cards | shared filters/card shell CSS ~485 lines; NodeCardPreview CSS 218 lines | file/text/web/image/mindmap/AI preview presentation now lives beside `NodeCardPreview/index.tsx`; filters and interactive card shell remain shared until their existing files move to owner folders |
