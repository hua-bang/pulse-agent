...
| Workspace node detail | NodeDetailDocument CSS ~683 lines; RelationEditor owner CSS 175 lines; ContextRail owner CSS 85 lines | relationship list/combobox/actions and source/AI/context rail follow the owner-folder convention; the bidirectional markup/style contract reads every owner stylesheet; header, supplementary, inspector, and canvas preview remain to migrate |
