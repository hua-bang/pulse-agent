...
| Workspace nodes page | `NodesPage/index.tsx` ~329 lines; owner CSS 122 lines | page shell/header/selection/grid follow the owner-folder convention; unreachable pre-CardShell `.workspace-node-card*` CSS is removed, and shared workspace-nodes CSS is 324 lines of tokens, buttons/chips/tags, and detail-page shell |
