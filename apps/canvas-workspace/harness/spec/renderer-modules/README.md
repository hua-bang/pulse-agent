...
| Workspace node detail | NodeDetailDocument CSS ~769 lines; RelationEditor owner CSS 175 lines | relationship list/combobox/actions now follow the owner-folder convention and the bidirectional markup/style contract test reads every owner stylesheet; header, rail, supplementary, inspector, and canvas preview remain to migrate |
