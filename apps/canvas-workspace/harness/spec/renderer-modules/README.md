...
| Workspace node detail | NodeDetailDocument CSS ~608 lines; RelationEditor owner CSS 175 lines; ContextRail 85 lines; Supplementary 75 lines | relationship editing, source/AI/context rail, and dock disclosures follow the owner-folder convention; the bidirectional markup/style contract reads every owner stylesheet; header, inspector, and canvas preview remain to migrate |
