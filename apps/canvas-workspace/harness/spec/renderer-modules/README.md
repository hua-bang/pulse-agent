...
| Workspace node cards | shared KnowledgeNodeCard/media CSS ~214 lines; CardShell CSS 52 lines; NodeCardPreview CSS 218 lines | preview and interactive wrapper follow owner folders; KnowledgeNodeCard identity/footer/tags/actions and shared hover/responsive rules remain together until the final card owner migration |
