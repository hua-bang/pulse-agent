...
| Artifacts | ChatInlineVisual ~375 lines / owner CSS 355; ArtifactTabView ~263 / 160; ChatArtifactCard ~115 / 121 | the three product visuals now follow owner folders instead of sharing a 625-line stylesheet; ChatInlineVisual still combines streaming iframe transport, final render selection, and toolbar presentation and is the remaining deepening seam |
