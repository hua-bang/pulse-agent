...
const CURRENT_OVER_500_BASELINE: Record<string, number> = {
  'src/renderer/src/components/AgentTeamFrame/index.css': 2928,
  'src/renderer/src/components/chat/ChatPanel.css': 2906,
  ...
  'src/renderer/src/components/CanvasNodeView/index.css': 1096,
  'src/renderer/src/components/ReferenceDrawer/index.css': 1017,
  'src/renderer/src/components/WorkspaceNodes/index.css': 1011,
  'src/renderer/src/hooks/useNodes.ts': 908,
  'src/renderer/src/components/Sidebar/index.css': 850,
  'src/plugins/main/channel/channels/feishu/feishu-channel.ts': 762,
  'src/renderer/src/components/Canvas/index.tsx': 742,
  'src/main/agent-teams/canvas-nodes.ts': 739,
  'src/renderer/src/components/WorkspaceNodes/GraphPage.tsx': 739,
  'src/main/agent/context-builder.ts': 698,
  'src/main/runtime/control-server.ts': 685,
  'src/main/runtime/mcp-server.ts': 652,
  'src/renderer/src/components/settings-config/McpManager.tsx': 612,
  'src/renderer/src/App.tsx': 604,
  ...
  'src/renderer/src/components/artifacts/artifacts.css': 554,
  'src/renderer/src/components/chat/hooks/useChatStream.ts': 542,
  'src/renderer/src/components/settings-config/settings-config.css': 532,
  ...
  'src/renderer/src/components/settings-config/SkillsManager.tsx': 505,
