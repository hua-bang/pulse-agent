 ...
 *  - DefaultCanvasNode (C1/C6/H2) React.lazy-loads six stateful/heavy node
 *    bodies (text/file/agent/frame/terminal/iframe), evicting editor packages
 *    and WebView lifecycle machinery from the entry.
