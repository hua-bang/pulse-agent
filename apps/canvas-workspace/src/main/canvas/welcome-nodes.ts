...
export function buildWelcomeCanvas(
  ...
  const nodes: CanvasNode[] = [
    ...
    mkNote('node-welcome-note', notes.welcome, notePaths.welcome, { x: 60, y: 460, width: 720, height: 400 }, now),
    mkText('node-onboard-practice-text', texts.practice, { x: 60, y: 920, width: 340, height: 140 }, now, { backgroundColor: '#FFF8C5' }),
    mkCard('node-onboard-first-minute', cards.firstMinute, { x: 840, y: 100, width: 640, height: 520 }, now),
    mkCard('node-onboard-features', cards.featureGrid, { x: 840, y: 680, width: 640, height: 340 }, now),
    ...
    mkNote('node-onboard-practice-note', notes.practice, notePaths.practice, { x: 1740, y: 570, width: 400, height: 370 }, now),
    ...
    // ---- 04 · Work with AI -------------------------------------------------
    mkFrame('node-onboard-frame-04', frames.ai, { x: 5180, y: 0, width: 2000, height: 1120 }, FRAME_COLORS.ai, now),
    mkCard('node-onboard-setup', cards.setup, { x: 5240, y: 100, width: 600, height: 520 }, now),
    mkCard('node-onboard-chat-mock', cards.chatMock, { x: 5240, y: 660, width: 600, height: 420 }, now),
    mkNote('node-onboard-prompts', notes.prompts, notePaths.prompts, { x: 5900, y: 100, width: 600, height: 400 }, now),
    mkNote('node-onboard-context', notes.context, notePaths.context, { x: 5900, y: 560, width: 600, height: 250 }, now),
    mkNote('node-onboard-ideas', notes.ideas, notePaths.ideas, { x: 6560, y: 100, width: 560, height: 300 }, now),
    mkText('node-onboard-feedback', texts.feedback, { x: 6560, y: 460, width: 560, height: 160 }, now, { backgroundColor: '#FFF8C5', fontSize: 16 }),

    // ---- 05 · Go deeper -----------------------------------------------------
    mkFrame('node-onboard-frame-05', frames.advanced, { x: 7300, y: 0, width: 1560, height: 1120 }, FRAME_COLORS.advanced, now),
    mkCard('node-onboard-workflow', cards.workflow, { x: 7360, y: 100, width: 720, height: 440 }, now),
    mkNote('node-onboard-project', notes.project, notePaths.project, { x: 7360, y: 600, width: 720, height: 400 }, now),
    mkCard('node-onboard-shortcuts', cards.shortcuts, { x: 8140, y: 100, width: 660, height: 400 }, now),
    mkText('node-onboard-multiws', texts.multiWorkspace, { x: 8140, y: 560, width: 660, height: 220 }, now, { fontSize: 15 }),
    {
