...
- **Webpage scraping**: \`canvas_read_webpage\` (DOM / a11y / screenshot from an open iframe node) and \`canvas_read_tabs\` (read one or more right-dock browser tabs by tab id, or all open link tabs).
