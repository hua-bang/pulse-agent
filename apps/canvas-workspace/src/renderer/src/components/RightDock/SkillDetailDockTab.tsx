import { ArrowUpRight, ChatCircleDots, FileText, FolderSimple, Globe } from '@phosphor-icons/react';
import type { CanvasSkillEntry } from '../../types';
import { useI18n } from '../../i18n';
import { notifyCanvasSkillsChanged } from '../../utils/skillsEvents';
import { MarkdownPreview } from '../FileNodeBodyLazy';
...
interface Props {
  ...
  onAddToChat: (workspaceId: string, skillName: string) => void;
      ...
      <div className="skill-detail__scroll">
        ...
        <section className="skill-detail__section">
          ...
          <div className="skill-detail__content">
            <MarkdownPreview content={skill.body || t('skillsLibrary.emptyBody')} />
          </div>
        </section>
        ...
        <section className="skill-detail__section">
          ...
          >
            ...
            <span>{t('skillsLibrary.open')}</span>
          </Button>
