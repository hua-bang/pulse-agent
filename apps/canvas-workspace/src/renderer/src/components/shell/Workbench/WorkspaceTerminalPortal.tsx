...
import { useRightDockTerminalHost } from '../../dock/RightDock';
import type { WorkspaceEntry } from '../../../hooks/useWorkspaces';
import type { CanvasNode } from '../../../types';
import type { DockTerminalWorkspaceState } from '../../dock/RightDock';
...
const WorkspaceTerminalDock = lazy(() =>
  import('../../dock/WorkspaceTerminalDock').then((m) => ({ default: m.WorkspaceTerminalDock })),
);
