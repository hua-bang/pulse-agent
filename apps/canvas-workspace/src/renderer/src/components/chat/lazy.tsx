...
// each surface loads on first mount (panel instances mount with the
// workbench, the page on first /chat visit) — off the startup critical
// path either way. Call sites import these drop-in wrappers instead of the
