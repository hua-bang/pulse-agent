...
import { isDockChatVisible, isDockTerminalVisible, useRightDock, useRightDockChatHost, useRightDockState } from '../../../components/dock/RightDock';
import { buildDockTabRefs } from '../../../components/dock/RightDock/tabRefs';
import { createReferenceNodeDataSnapshot } from '../../../components/dock/ReferenceDrawer/utils';
import type { NodeReferenceEntry as NodeReferenceEntryForCanvas } from '../../../components/dock/ReferenceDrawer/types';
...
const ReferenceDrawer = lazy(() => import('../../../components/dock/ReferenceDrawer').then((m) => ({ default: m.ReferenceDrawer })));
