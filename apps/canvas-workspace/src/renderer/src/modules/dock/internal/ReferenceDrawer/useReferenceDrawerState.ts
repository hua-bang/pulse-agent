...
} from '../../../../shared/reference/constants';
import type { NodeReferenceEntry, ReferenceEntry, ReferencePickerMode } from '../../../../shared/reference/types';
import {
  getNodeReferenceId,
  getReferenceId,
  getUrlHostname,
