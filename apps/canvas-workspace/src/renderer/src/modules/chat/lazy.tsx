...
const ChatPageInner = lazy(() => import('./components/ChatPage').then((m) => ({ default: m.ChatPage })));
const ChatPanelInner = lazy(() => import('./components/ChatPanel').then((m) => ({ default: m.ChatPanel })));
