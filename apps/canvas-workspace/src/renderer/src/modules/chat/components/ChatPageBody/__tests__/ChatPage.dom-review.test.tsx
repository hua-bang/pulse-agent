...
import { ChatTargetProvider, useChatTargetBroker } from '../../../target';
...
describe('ChatPage DOM review delivery', () => {
  ...
  it('keeps image upload available for global AI chat', async () => {
    ...
    const latestProps = chatView.latestProps as Record<string, unknown> | null;
    const composerProps = latestProps?.composer as Record<string, unknown> | undefined;
