...
export const useChatPanelController = ({
  workspaceId,
  ...
  return {
    ...
    thread: {
        pendingLabel, messages, loading, agentScope, sessionLoading, workspaceId: scopeId, rootFolder,
    ...
    context: {
        nodes, selectedContext, showContextChips: agentScope.kind === 'global', onRemoveContext,
