...
- Cross-workspace Canvas capability protocol: `harness/skills/add-canvas-capability/` keeps Capability Runtime as the single implementation boundary while routing native Tool, Pulse Agent, and external CLI adapters through the owning workspace checks.
